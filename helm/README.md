...
```console
$ helm install my-release oci://ghcr.io/eclipse-edc/charts/data-dashboard --version 0.6.0
```
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/eclipse-edc/data-dashboard","tag":"0.6.0"}` | This sets the container image more information can be found here: https://kubernetes.io/docs/concepts/containers/images/ |
