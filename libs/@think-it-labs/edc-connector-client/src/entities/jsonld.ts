...
export class JsonLdObject {
  ...
  private getNamespaceUrl(prefix: string): string {
    switch (prefix) {
      ...
      case 'dcterms': return 'https://purl.org/dc/terms/';
      case 'segitturont': return 'https://ontologia.segittur.es/turismo/def/core/';
      case 'dqv': return 'https://www.w3.org/ns/dqv/';
