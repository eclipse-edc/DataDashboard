...
export const APIS = [ApplicationObservabilityService, AssetService, ContractAgreementService, ContractDefinitionService, ContractNegotiationService, DataplaneSelectorService, DefaultService, HTTPProvisionerWebhookService, IdentityHubService, PolicyService, TransferProcessService];
